...
class RequestMitraPolicy
{
     ...
     */
    public function restore(User $user, RequestMitra $requestMitra): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, RequestMitra $requestMitra): bool
    {
        return false;
    }
}
