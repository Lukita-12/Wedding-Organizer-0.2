...
class KerjasamaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        collect([
            ...
            ['1', '-', '0821 5483 5452', '-', 'Jl. Perdagangan, RT.22/RW.008, rumah pagar, stainles, Kota Banjarmasin, Kalimantan Selatan 70124'],
            ['2', '-', '0896 9170 6577', 'nijhumhossain84@gmail.com', 'Jl. Perdagangan No.179, Alalak Utara, Kec. Banjarmasin Utara, Kota Banjarmasin, Kalimantan Selatan 70124'],
            ['3', '-', '0831-2533-3629', 'raditharv@gmail.com', 'Jl. Batu Benawa Raya No.19A, Tlk. Dalam, Kec. Banjarmasin Tengah, Kota Banjarmasin, Kalimantan Selatan 70117'],
            ['4', '-', '082154468667', '-', 'Jl. Sultan Adam Komp. Mandiri IV, Surgi Mufti, Kec. Banjarmasin Utara, Kota Banjarmasin, Kalimantan Selatan 70122'],
            ['5', '-', '0813-4950-0959', 'ayucatring23@gamil.com', 'KOMPLEK.HERLINA, Jl. Hksn No.19 BLOK A, RT.12/RW.2, Alalak Sel., Kec. Banjarmasin Utara, Kota Banjarmasin, Kalimantan Selatan 70126'],
            ['6', '-', '0811 507 2255', '-', 'Jl. Sungai Miai Dalam, RT.6/RW.no 35, Sungai Miai, Kec. Banjarmasin Utara, Kota Banjarmasin, Kalimantan Selatan 70117'],
        ])->each(function ($item) {
