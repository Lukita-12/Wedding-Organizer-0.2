<x-layout>
    ...
    <div>
        <x-form.layout action="{{ route('customer.kerjasama.update', $kerjasama->id) }}">
            @method('PUT')
            <x-form.container>
                ...
                <x-form.button-container>
                    <x-form.button-link href="{{ route('customer.kerjasama.show', $kerjasama->id) }}">Batal</x-form.button-link>
