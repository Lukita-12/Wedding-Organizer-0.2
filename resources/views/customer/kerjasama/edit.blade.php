        ...
        <x-form.form action="{{ route('customer.kerjasama.update', $kerjasama) }}">
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="py-4 flex justify-end items-center gap-3">
                    <a href="{{ route('customer.kerjasama.index') }}" class="w-1/10 inline-block h-fit border-2 border-red-500 px-3 poppins-semibold text-center text-lg text-red-500 rounded-md transition duration:300 hover:bg-red-500 hover:text-slate-100 hover:ring-2 hover:ring-offset-2 hover:ring-red-500">Batal</a>
