        ...
        <div class="h-56 bg-slate-700 bg-cover bg-center flex flex-col justify-end items-center py-4">        
            <div class="w-full flex flex-col items-center">
                ...
                <nav class="w-1/2 flex justify-center px-4 gap-4">
                    <a href="#" class="poppins-light text-slate-100 transition delay-50 duration-300 hover:text-slate-400">Home</a>
                    <a href="#" class="poppins-light text-slate-100 transition delay-50 duration-300 hover:text-slate-400">Kerjasama</a>
                    <a href="#" class="poppins-light text-slate-100 transition delay-50 duration-300 hover:text-slate-400">Akun</a>
                    <a href="#" class="poppins-light text-slate-100 transition delay-50 duration-300 hover:text-slate-400">Log Out</a>
                </nav>
            </div>
        </div>
    </main>
