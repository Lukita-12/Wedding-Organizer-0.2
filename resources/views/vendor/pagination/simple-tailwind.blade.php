        ...
        @if ($paginator->onFirstPage())
            <span
                class="relative inline-flex items-center text-slate-200 leading-5 cursor-default
                    bg-teal-600 w-fit px-3 py-2 justify-center poppins-medium border border-slate-300
        ...
        @else
            <a href="{{ $paginator->previousPageUrl() }}" rel="prev"
                class="relative inline-flex items-center text-slate-100 leading-5
                    bg-teal-500 w-fit px-3 py-2 justify-center poppins-medium border border-slate-300
