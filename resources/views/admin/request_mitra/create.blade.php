<x-layout-form>
    ...
    <x-form.container variant="main">
        <x-form.form action="{{ route('admin.request_mitra.store') }}">
            <x-form.container variant="form">
                ...
                <x-form.container>
                    ...
                    <x-form.input type="text" name="nama_pemilik" id="nama_pemilik" :value="old('nama_pemilik')" placeholder="Nama pemilik" required />
