<x-layout>
    ...
    <div>
        <x-form.layout action="{{ route('admin.kerjasama.update', $kerjasama->id) }}">
            @method('PUT')
            <x-form.container>
                ...
                <x-form.button-container>
                    <x-form.button-link href="{{ route('admin.kerjasama.show', $kerjasama->id) }}">Batal</x-form.button-link>
