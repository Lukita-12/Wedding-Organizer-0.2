    ...
    <div class="w-full bg-slate-200 shadow shadow-slate-500 px-4 py-2">
        <form method="POST" action="{{ route('admin.pelanggan.store') }}">
            ...
            <div class="flex flex-col gap-3">
                <div>
                    <label for="user" class="block poppins-semibold text-slate-700 text-xl px-3">User</label>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" name="nama_pelanggan" id="nama_pelanggan" value="{{ old('nama_pelanggan') }}" placeholder="Nama lengkap" class="w-full poppins bg-slate-100 text-slate-700 text-lg px-3 py-1" required>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" name="noTelp_pelanggan" id="noTelp_pelanggan" value="{{ old('noTelp_pelanggan') }}" placeholder="No. Telpon/WA" class="w-full poppins bg-slate-100 text-slate-700 text-lg px-3 py-1" required>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="email" name="email_pelanggan" id="email_pelanggan" value="{{ old('email_pelanggan') }}" placeholder="Email" class="w-full poppins bg-slate-100 text-slate-700 text-lg px-3 py-1" required>
