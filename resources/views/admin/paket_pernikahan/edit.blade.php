<x-layout-form>
            ...
            <x-form.container variant="form">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="venue" id="venue">
                            ...
                            @foreach ($kerjasamaByJenis['Venue'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('venue', $paketPernikahan->venue) === (string) $kerjasama->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_venue" id="ket_venue" :value="old('ket_venue', $paketPernikahan->ket_venue)" placeholder="Info venue..." />
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="dekorasi" id="dekorasi">
                            ...
                            @foreach ($kerjasamaByJenis['Dekorasi'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('dekorasi', $paketPernikahan->dekorasi) === (string) $kerjasama->id ? 'selected' : '' }}>
                                    {{ $kerjasama->requestMitra->nama_usaha }}
                                </option>
                            @endforeach
                        </x-form.select>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_dekorasi" id="ket_dekorasi" :value="old('ket_dekorasi', $paketPernikahan->ket_dekorasi)" placeholder="Info dekorasi..." />
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="tata_rias" id="tata_rias">
                            ...
                            @foreach ($kerjasamaByJenis['Tata rias'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('tata_rias', $paketPernikahan->tata_rias) === (string) $kerjasama->id ? 'selected' : '' }}>
                                    {{ $kerjasama->requestMitra->nama_usaha }}
                                </option>
                            @endforeach
                        </x-form.select>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_tata_rias" id="ket_tata_rias" :value="old('ket_tata_rias', $paketPernikahan->ket_tata_rias)" placeholder="Info tata rias..." />
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="catering" id="catering">
                            ...
                            @foreach ($kerjasamaByJenis['Catering'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('catering', $paketPernikahan->catering) === (string) $kerjasama->id ? 'selected' : '' }}>
                                    {{ $kerjasama->requestMitra->nama_usaha }}
                                </option>
                            @endforeach
                        </x-form.select>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_catering" id="ket_catering" :value="old('ket_catering', $paketPernikahan->ket_catering)" placeholder="Info catering..." />
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="kue_pernikahan" id="kue_pernikahan">
                            ...
                            @foreach ($kerjasamaByJenis['Kue pernikahan'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('kue_pernikahan', $paketPernikahan->kue_pernikahan) === (string) $kerjasama->id ? 'selected' : '' }}>
                                    {{ $kerjasama->requestMitra->nama_usaha }}
                                </option>
                            @endforeach
                        </x-form.select>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_kue_pernikahan" id="ket_kue_pernikahan" :value="old('ket_kue_pernikahan', $paketPernikahan->ket_kue_pernikahan)" placeholder="Info kue pernikahan..." />
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="fotografer" id="fotografer">
                            ...
                            @foreach ($kerjasamaByJenis['Fotografer'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('fotografer', $paketPernikahan->fotografer) === (string) $kerjasama->id ? 'selected' : '' }}>
                                    {{ $kerjasama->requestMitra->nama_usaha }}
                                </option>
                            @endforeach
                        </x-form.select>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_fotografer" id="ket_fotografer" :value="old('ket_fotografer', $paketPernikahan->ket_fotografer)" placeholder="Info foto..." />
                    ...
                    <div class="flex flex-col">
                        ...
                        <x-form.select name="entertainment" id="entertainment">
                            ...
                            @foreach ($kerjasamaByJenis['Entertainment'] as $kerjasama)
                                <option value="{{ $kerjasama->id }}" {{ (string) old('entertainment', $paketPernikahan->entertainment) === (string) $kerjasama->id ? 'selected' : '' }}>
                                    {{ $kerjasama->requestMitra->nama_usaha }}
                                </option>
                            @endforeach
                        </x-form.select>
                    ...
                    <div>
                        ...
                        <x-form.input type="text" name="ket_entertainment" id="ket_entertainment" :value="old('ket_entertainment', $paketPernikahan->ket_entertainment)" placeholder="Info ket_entertainment..." />
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            @if ($paketPernikahan->upload_file)
                previewImage.src = "{{ asset('storage/' . $paketPernikahan->upload_file) }}";
                previewImage.classList.remove('hidden');
                uploadPlaceholder.classList.add('hidden');
            @endif

            // Ganti preview jika pilih file baru
