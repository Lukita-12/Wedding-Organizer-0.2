<x-layout>
    ...
    <x-form.container variant="main">
        <x-form.form action="{{ route('admin.pesanan.store') }}">
            <x-form.container variant="form">
                ...
                <div>
                    ...
                    <x-form.input type="date" name="tgl_pesanan" id="tgl_pesanan" :value="old('tgl_pesanan')" required />
                ...
                <div>
                    ...
                    <x-form.input type="text" name="pengantin_wanita" id="pengantin_wanita" :value="old('pengantin_wanita')" placeholder="Nama pengantin wanita..." required />
                ...
                <div>
                    ...
                    <x-form.input type="text" name="total_harga_pesanan" id="total_harga_pesanan" :value="old('total_harga_pesanan')" placeholder="000.000.000" required />
                    <x-form.error errorFor="total_harga_pesanan" />
                </div>

                <div>
                    <x-form.label for="status_pesanan">Status Pesanan</x-form.label>
                    <x-form.select name="status_pesanan" id="status_pesanan" required>
                        <option value="Dalam proses"{{ old('status_pesanan') === 'Dalam proses' ? 'selected' : '' }}>Dalam proses</option>
